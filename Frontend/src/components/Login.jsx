...
toast.error(err.response?.data?.message, {
  ...
  return (
   <div className='w-full h-screen flex justify-center items-center '>
           ...
           <span className='w-[55%]  text-center font-bold text-slate-500'>Sign in to see photos and videos from your friends.
           </span>
           <form  onSubmit={handleSubmit(submithandler)} className='flex w-[100%] h-[40%] flex-col items-center justify-center '>
   ...
   By signing up, you agree to our Terms , Privacy Policy and Cookies Policy</p>
               <button disabled={isLoading} className='bg-blue-400 cursor-pointer my-1 text-white m-x-auto w-[80%] p-2 rounded-md' type='submit'>{isLoading?"Logging in...":"Log in"}</button>
               </form>
               <span className='text-center text-black-400 text-sm w-[30%] m-x-auto' >Dont have an account?</span>
